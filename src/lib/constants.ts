...
export const RESTORATION_PRESETS = [
  {
    ...
    icon: AlertCircle,
    prompt:
      'Repair torn areas and missing regions using context-aware reconstruction consistent with the surrounding photographic structure.',
  },
  {
    id: 'facial_identity',
    ...
    icon: User,
    prompt:
      'Preserve facial identity and expression exactly as in the original image. Reconstruct damaged areas naturally without changing age, facial proportions or historical authenticity.',
  },
  {
    id: 'colorization',
...
export const PRICE_TABLE: Record<string, Record<string, number>> = {
  'gemini-3.1-flash-image-preview': { '1K': 0.01, '2K': 0.02, '4K': 0.0 },
